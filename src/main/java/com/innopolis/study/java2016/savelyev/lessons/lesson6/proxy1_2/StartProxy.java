package com.innopolis.study.java2016.savelyev.lessons.lesson6.proxy1_2;
...
//		System.out.println(((SecondInterface) proxy).doSomethingElse2());
		...
		SuperABC superABC = new SuperABC() {
			@Override
			public int doSome(int n) {
				return 5;
			}
			...
			@Override
			public int doSomethingElse2() {
				return 100;
			}
		};

		System.out.println("Интерфейс тип 2: ");

		System.out.println(superABC.doSome(20));
		System.out.println(superABC.doSomethingElse());
		System.out.println(superABC.doSomethingElse2());

	}
}

interface SuperABC extends FirstInterface, SecondInterface {};
